...
namespace Flowcode\MediaBundle\DependencyInjection;
 ...
 */
class FlowcodeMediaExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('flowcode_media.media_types', $config['media_types']);
